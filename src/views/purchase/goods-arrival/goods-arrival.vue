            ...
            <Col>
                <Card>
                    ...
                    <Row class="margin-top-10" style="stripe">
                        <can-edit-table :loading="loading" @on-arrival="arrivalConfirm" v-model="data" :columns-list="columns" :provider="provider"></can-edit-table>
                    </Row>
...
<script>
import * as table from "./data/goods-arrival";
...
export default {
  ...
  methods: {
    ...
    //确认收货
    arrivalConfirm(val,index) {
    	this.formItem = {};
    	this.formItem = val[index];
    	this.formItem.orderStatus = 7;
